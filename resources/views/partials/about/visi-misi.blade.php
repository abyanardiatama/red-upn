<section class="bg-white dark:bg-gray-900">
    <div class="p-8 px-10 mx-auto max-w-screen-xl">
        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg mb-8">
            ...
            <h1 class="dark:text-white text-3xl md:text-5xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-secondary from-10% via-primary via-30% to-black to-90%">Foto Pengurus</h1>
